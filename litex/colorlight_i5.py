...
# Importante: Importar GPIOOut e GPIOIn
...
# --- DEFINIÇÃO DE PINOS EXTRAS ---

# 1. Definição dos 8 LEDs para o conector CN2
_leds_8bit_io = [
    ("user_leds_byte", 0, Pins("P17 P18 N18 L20 L18 G20 M18 N17"), IOStandard("LVCMOS33")),
]

# 2. Definição do Botão SW1 com Pull-Up para o conector CN2
# Misc("PULLMODE=UP") ativa o resistor interno de pull-up do FPGA.
_button_io = [
    ("user_button", 0, Pins("T17"), IOStandard("LVCMOS33"), Misc("PULLMODE=UP")),
]
...
class BaseSoC(SoCCore):
    def __init__(self, board="i5", revision="7.0", toolchain="trellis", sys_clk_freq=60e6,
        ...
        **kwargs):
        ...
        # --- EXTENSÃO 1: Configuração dos 8 LEDs ---
        platform.add_extension(_leds_8bit_io)
        self.leds_8bit = GPIOOut(platform.request("user_leds_byte"))
        
        # --- EXTENSÃO 2: Configuração do Botão (Input + Pull-up) ---
        platform.add_extension(_button_io)
        self.button = GPIOIn(platform.request("user_button"))
        # -----------------------------------------------------------
