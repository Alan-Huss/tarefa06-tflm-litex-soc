...
/* BUTTON Registers */
#define CSR_BUTTON_BASE (CSR_BASE + 0x0L)
#define CSR_BUTTON_IN_ADDR (CSR_BASE + 0x0L)
...
/* LEDS_8BIT Registers */
#define CSR_LEDS_8BIT_BASE (CSR_BASE + 0x2000L)
#define CSR_LEDS_8BIT_OUT_ADDR (CSR_BASE + 0x2000L)
#define CSR_LEDS_8BIT_OUT_SIZE 1
...
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_ADDR (CSR_BASE + 0x3004L)
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_SIZE 1
#define CSR_SPIFLASH_MASTER_CS_ADDR (CSR_BASE + 0x3008L)
#define CSR_SPIFLASH_MASTER_CS_SIZE 1
#define CSR_SPIFLASH_MASTER_PHYCONFIG_ADDR (CSR_BASE + 0x300cL)
#define CSR_SPIFLASH_MASTER_PHYCONFIG_SIZE 1
#define CSR_SPIFLASH_MASTER_RXTX_ADDR (CSR_BASE + 0x3010L)
#define CSR_SPIFLASH_MASTER_RXTX_SIZE 1
#define CSR_SPIFLASH_MASTER_STATUS_ADDR (CSR_BASE + 0x3014L)
...
/* LEDS_8BIT Access Functions */
static inline uint32_t leds_8bit_out_read(void) {
	return csr_read_simple((CSR_BASE + 0x2000L));
}
static inline void leds_8bit_out_write(uint32_t v) {
