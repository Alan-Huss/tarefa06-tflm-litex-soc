...
// LiteX sha1 : 05ddccb20
// Date       : 2025-11-30 10:19:05
//------------------------------------------------------------------------------
...
module colorlight_i5 (
    ...
    output wire    [7:0] user_leds_byte
);
...
wire    [7:0] csr_bankarray_csrbank5_phy_clk_divisor0_r;
reg           csr_bankarray_csrbank5_phy_clk_divisor0_re = 1'd0;
wire    [7:0] csr_bankarray_csrbank5_phy_clk_divisor0_w;
reg           csr_bankarray_csrbank5_phy_clk_divisor0_we = 1'd0;
...
reg           leds_8bit_re = 1'd0;
reg     [7:0] leds_8bit_storage = 8'd0;
...
assign user_leds_byte = leds_8bit_storage;
...
assign csr_bankarray_csrbank0_in_w = button_status;
assign button_we = csr_bankarray_csrbank0_in_we;
...
assign csr_bankarray_csrbank3_out0_w = leds_8bit_storage;
...
assign csr_bankarray_csrbank5_phy_clk_divisor0_r = csr_bankarray_interface5_bank_bus_dat_w[7:0];
always @(*) begin
    csr_bankarray_csrbank5_phy_clk_divisor0_re <= 1'd0;
    csr_bankarray_csrbank5_phy_clk_divisor0_we <= 1'd0;
    if ((csr_bankarray_csrbank5_sel & (csr_bankarray_interface5_bank_bus_adr[8:0] == 1'd0))) begin
        csr_bankarray_csrbank5_phy_clk_divisor0_re <= csr_bankarray_interface5_bank_bus_we;
        csr_bankarray_csrbank5_phy_clk_divisor0_we <= csr_bankarray_interface5_bank_bus_re;
    end
end
...
always @(*) begin
    ...
    if ((csr_bankarray_csrbank5_sel & (csr_bankarray_interface5_bank_bus_adr[8:0] == 1'd1))) begin
        ...
        csr_bankarray_csrbank5_mmap_dummy_bits0_we <= csr_bankarray_interface5_bank_bus_re;
    end
end
...
always @(*) begin
    ...
    if ((csr_bankarray_csrbank5_sel & (csr_bankarray_interface5_bank_bus_adr[8:0] == 2'd2))) begin
        ...
        csr_bankarray_csrbank5_master_cs0_we <= csr_bankarray_interface5_bank_bus_re;
    end
end
...
always @(*) begin
    ...
    if ((csr_bankarray_csrbank5_sel & (csr_bankarray_interface5_bank_bus_adr[8:0] == 2'd3))) begin
        ...
        csr_bankarray_csrbank5_master_phyconfig0_we <= csr_bankarray_interface5_bank_bus_re;
    end
end
assign basesoc_master_rxtx_r = csr_bankarray_interface5_bank_bus_dat_w;
always @(*) begin
    ...
    if ((csr_bankarray_csrbank5_sel & (csr_bankarray_interface5_bank_bus_adr[8:0] == 3'd4))) begin
        ...
        basesoc_master_rxtx_we <= csr_bankarray_interface5_bank_bus_re;
    end
end
...
always @(*) begin
    ...
    if ((csr_bankarray_csrbank5_sel & (csr_bankarray_interface5_bank_bus_adr[8:0] == 3'd5))) begin
        ...
        csr_bankarray_csrbank5_master_status_we <= csr_bankarray_interface5_bank_bus_re;
    end
end
assign csr_bankarray_csrbank5_phy_clk_divisor0_w = basesoc_spiflash_phy_storage;
assign csr_bankarray_csrbank5_mmap_dummy_bits0_w = basesoc_mmap_storage;
...
assign csr_bankarray_csrbank5_master_phyconfig0_w = basesoc_master_phyconfig_storage;
always @(*) begin
...
assign csr_bankarray_csrbank5_master_status_w = basesoc_master_status_status;
...
assign basesoc_uart_rxtx_r = csr_bankarray_interface7_bank_bus_dat_w[7:0];
always @(*) begin
    ...
    if ((csr_bankarray_csrbank7_sel & (csr_bankarray_interface7_bank_bus_adr[8:0] == 1'd0))) begin
        basesoc_uart_rxtx_re <= csr_bankarray_interface7_bank_bus_we;
        basesoc_uart_rxtx_we <= csr_bankarray_interface7_bank_bus_re;
    end
end
...
assign csr_bankarray_csrbank7_txfull_w = basesoc_uart_txfull_status;
assign basesoc_uart_txfull_we = csr_bankarray_csrbank7_txfull_we;
assign csr_bankarray_csrbank7_rxempty_w = basesoc_uart_rxempty_status;
assign basesoc_uart_rxempty_we = csr_bankarray_csrbank7_rxempty_we;
always @(*) begin
...
assign csr_bankarray_csrbank7_ev_status_w = basesoc_uart_status_status;
assign basesoc_uart_status_we = csr_bankarray_csrbank7_ev_status_we;
always @(*) begin
...
assign csr_bankarray_csrbank7_ev_pending_w = basesoc_uart_pending_status;
assign basesoc_uart_pending_we = csr_bankarray_csrbank7_ev_pending_we;
assign basesoc_uart_tx2 = basesoc_uart_enable_storage[0];
assign basesoc_uart_rx2 = basesoc_uart_enable_storage[1];
assign csr_bankarray_csrbank7_ev_enable0_w = basesoc_uart_enable_storage;
assign csr_bankarray_csrbank7_txempty_w = basesoc_uart_txempty_status;
assign basesoc_uart_txempty_we = csr_bankarray_csrbank7_txempty_we;
assign csr_bankarray_csrbank7_rxfull_w = basesoc_uart_rxfull_status;
assign basesoc_uart_rxfull_we = csr_bankarray_csrbank7_rxfull_we;
...
assign button_status = multiregimpl1_regs1;
...
always @(posedge sys_clk) begin
    ...
    button_re <= csr_bankarray_csrbank0_in_re;
    ...
    if (csr_bankarray_csrbank3_out0_re) begin
        leds_8bit_storage <= csr_bankarray_csrbank3_out0_r;
    end
    leds_8bit_re <= csr_bankarray_csrbank3_out0_re;
    ...
    if (csr_bankarray_csrbank5_sel) begin
        case (csr_bankarray_interface5_bank_bus_adr[8:0])
            1'd0: begin
                csr_bankarray_interface5_bank_bus_dat_r <= csr_bankarray_csrbank5_phy_clk_divisor0_w;
            end
            1'd1: begin
    ...
    if (csr_bankarray_csrbank5_phy_clk_divisor0_re) begin
        basesoc_spiflash_phy_storage <= csr_bankarray_csrbank5_phy_clk_divisor0_r;
    end
    basesoc_spiflash_phy_re <= csr_bankarray_csrbank5_phy_clk_divisor0_re;
    if (csr_bankarray_csrbank5_mmap_dummy_bits0_re) begin
        basesoc_mmap_storage <= csr_bankarray_csrbank5_mmap_dummy_bits0_r;
    end
    basesoc_mmap_re <= csr_bankarray_csrbank5_mmap_dummy_bits0_re;
    ...
    if (csr_bankarray_csrbank5_master_phyconfig0_re) begin
        basesoc_master_phyconfig_storage <= csr_bankarray_csrbank5_master_phyconfig0_r;
    end
    ...
    if (csr_bankarray_csrbank7_sel) begin
        case (csr_bankarray_interface7_bank_bus_adr[8:0])
            1'd0: begin
                csr_bankarray_interface7_bank_bus_dat_r <= basesoc_uart_rxtx_w;
            end
            1'd1: begin
    ...
    basesoc_uart_txfull_re <= csr_bankarray_csrbank7_txfull_re;
    basesoc_uart_rxempty_re <= csr_bankarray_csrbank7_rxempty_re;
    basesoc_uart_status_re <= csr_bankarray_csrbank7_ev_status_re;
    if (csr_bankarray_csrbank7_ev_pending_re) begin
        basesoc_uart_pending_r <= csr_bankarray_csrbank7_ev_pending_r;
    end
    basesoc_uart_pending_re <= csr_bankarray_csrbank7_ev_pending_re;
    if (csr_bankarray_csrbank7_ev_enable0_re) begin
        basesoc_uart_enable_storage <= csr_bankarray_csrbank7_ev_enable0_r;
    end
    basesoc_uart_enable_re <= csr_bankarray_csrbank7_ev_enable0_re;
    basesoc_uart_txempty_re <= csr_bankarray_csrbank7_txempty_re;
    basesoc_uart_rxfull_re <= csr_bankarray_csrbank7_rxfull_re;
    if (sys_rst) begin
    ...
    multiregimpl1_regs0 <= user_button;
...
//------------------------------------------------------------------------------
// Memory rom: 9456-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-11-30 10:19:05.
//------------------------------------------------------------------------------
